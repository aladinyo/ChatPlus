...
function getCallItems(participants) {
    ...
    for (const [id, participant] of Object.entries(participants)) {
        callItems[id === "local" ? "local" : "otherUser"] = {
...
const reducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case "set_notif_tiemout" :
            return {
                ...state,
                notifTimeout: action.notifTimeout
            }
        case "set_call_type" :
            return {
                ...state,
        ...
        case "set_other_user_photo" : 
            return {
                ...state,
                photo: action.photo
            }
        case "set_other_user_ratio" :
            return {
                ...state,
                otherUserRatio: action.otherUserRatio
            }
        case "set_other_user_name":
            return {
                ...state,
                otherUserName: action.otherUserName
            }
        case "set_call_queries" :
            return {
                ...state,
                callQueries: action.callQueries
            }
        case "set_caller":
            return {
                ...state,
        ...
        case "set_call_room":
            return {
                ...state,
                callRoom: action.callRoom
            }
        case "participants_change" :
            return {
                ...state,
                callItems: getCallItems(action.participants)
            }
